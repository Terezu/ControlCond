...
class Faturas(models.Model):
    ...
    leitura = models.ForeignKey('Leituras', models.DO_NOTHING, blank=True, null=True)
...
class Medicoes(models.Model):
    morador = models.ForeignKey('Moradores', models.DO_NOTHING)
    mes = models.IntegerField()
    ano = models.IntegerField()
    leitura_anterior_agua = models.FloatField()
    leitura_atual_agua = models.FloatField()
    consumo_agua = models.FloatField()
    leitura_anterior_gas = models.FloatField()
    leitura_atual_gas = models.FloatField()
    consumo_gas = models.FloatField()
    valor_agua = models.FloatField(blank=True, null=True)
    valor_gas = models.FloatField(blank=True, null=True)
    valor_total = models.FloatField(blank=True, null=True)
